<html lang="en"><!--begin::Head-->
	...
	<div class="header-menu align-items-stretch drawer drawer-end" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}" style="width: 250px !important;">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Page-->
			<div class="page d-flex flex-row flex-column-fluid" style="background-color: #eaeaea">
				<!--begin::Aside-->
				<div id="kt_aside" class="aside aside-hoverable drawer drawer-start" style="background-color: #275F3B;"
				...
				style="width: 250px !important;">
					<!--begin::Brand-->
					<div class="aside-logo flex-column-auto" id="kt_aside_logo" style="background-color: #ffffff; border-bottom: 1px solid; border-color:pink; height:121px">
						<!--begin::Logo-->
						<a href="../../demo1/dist/index.html">
							<img alt="Logo" src="assets/media/logos/km4.png" width="220px" height="80px">
						</a>
						<!--end::Logo-->
						<!--begin::Aside toggler-->
					...
					<!--begin::Aside menu-->
					<!--begin::Menu-->
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" style=" margin-top: 20px;">
								
								<div class="menu-item" style="height: 68px; font-size: 16px;">
									<a class="menu-link active" href="http://127.0.0.1:8000/barangs">
										...
										<span class="menu-title" style="color: white; font-weight: 700">Data Barang</span>
									</a>
								</div>
								<div class="menu-item" style="height: 68px; font-size: 16px;">
									<a class="menu-link active" href="http://127.0.0.1:8000/brg_masuks">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span >
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title" style="color: white; font-weight: 700">Data Barang Masuk</span>
									</a>
								</div>
								<div class="menu-item" style="height: 68px; font-size: 16px;">
									<a class="menu-link active" href="http://127.0.0.1:8000/brg_keluars">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span >
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title" style="color: white; font-weight: 700">Data Barang Keluar</span>
									</a>
								</div>
								<div class="menu-item" style="height: 68px; font-size: 16px;">
									<a class="menu-link active" href="http://127.0.0.1:8000/customers">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span>
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title" style="color: white; font-weight: 700">Data Customer</span>
									</a>
								</div>
								<div class="menu-item" style="height: 68px; font-size: 16px;">
									<a class="menu-link active" href="http://127.0.0.1:8000/users">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span>
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title" style="color: white; font-weight: 700">Data User</span>
									</a>
								</div>
								<div class="menu-item" style="height: 68px; font-size: 16px;">
									</div><a class="menu-link" href="../../demo1/dist/dashboards/no-toolbar.html">
							<!--end::Menu-->
				...
				<!--end::Aside-->
				<!--begin::Wrapper-->
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="background-color: #EAEAEA">
					<!--begin::Header-->
...
-->
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												<img src="assets/media/avatars/ivonne.jpg" alt="user">
											</div>
											<!--begin::Menu-->
					...
					<!--end::Header-->
					<!--begin::Content-->
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="background-color: #EAEAEA">
						<!--begin::Toolbar-->
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-1 my-1" >@yield('judul_header')
									<!--begin::Separator-->
