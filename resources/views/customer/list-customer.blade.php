...
@endsection
@section('judul_header', 'Data Customer')
                        ...
                        <div class="card border-0 shadow-sm rounded-md mt-4">
                            <div class="card-body">
                                ...
                                <tbody id="table-customers">
                                    ...
                                    <td style="padding-left:10px">{{ $customer->nama_customer }}</td>
                                    <td>{{ $customer->jenis_kelamin }}</td>
                                    <td>{{ $customer->alamat }}</td>
                                    <td>{{ $customer->email }}</td>
                                    <td>{{ $customer->password }}</td>
                                    <td class="text-center"> <a href="javascript:void(0)" id="btn-edit-post" data-id="{{ $customer->id }}" class="btn btn-primary btn-sm">EDIT</a>
